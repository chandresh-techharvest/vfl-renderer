...
{
    /// <summary>
    /// Base API client for MyBill portal - uses MyBillBaseUrl
    /// </summary>
    public abstract class MyBillBaseApiClient : IApiClient
    {
        ...
        protected MyBillBaseApiClient(HttpClient httpClient, IOptions<ApiSettings> options, ILogger logger, IMemoryCache cache)
        {
        ...
        protected MyBillBaseApiClient(HttpClient httpClient, IOptions<ApiSettings> options, ILogger logger, IMemoryCache cache, IHttpContextAccessor httpContextAccessor)
        {
            _httpClient = httpClient ?? throw new ArgumentNullException(nameof(httpClient));
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _cache = cache ?? throw new ArgumentNullException(nameof(cache));
