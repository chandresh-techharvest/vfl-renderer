...
{
    public class CustomLoginFormModel : ICustomLoginFormModel
    { 
        ...
        public CustomLoginFormModel(IODataRestClient restService, IStyleClassesProvider styles, IHttpContextAccessor httpContextAccessor)
        {
        ...
        /// <inheritdoc/>
        public virtual async Task<CustomLoginFormViewModel> InitializeViewModel(CustomLoginFormEntity entity)
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));

            var viewModel = new CustomLoginFormViewModel
            {
                LoginHandlerPath = "api/LoginForm/Login",
            ...
            if (entity.VerificationPage.ItemIdsOrdered != null)
            {
